        ...
        >
          ...
          >
            <View style={{ flexDirection: "row" }}>
              <Image
                style={styles.image}
                source={require("../../assets/retirotabernaculo.png")}
              />
              ...
              <View style={{ marginLeft: 4 }}>
                <Text style={styles.eventTitle}>
                  O Tabernáculo e a Espiritualidade Cristã
                </Text>
        ...
        <View style={styles.eventBox}>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              <Image
                style={styles.image}
                source={require("../../assets/oracaomadrugada.png")}
              />
              ...
              <View style={{ marginLeft: 4 }}>
                <Text style={styles.eventTitle}>
                  Reunião de oração da madrugada
                </Text>
        ...
        <View style={styles.eventBox}>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              <Image
                style={styles.image}
                source={require("../../assets/encontrodeoracaosemanal.png")}
              />
              ...
              <View style={{ marginLeft: 4 }}>
                <Text style={styles.eventTitle}>
                  Encontro de oração semanal do ministério...
                </Text>
